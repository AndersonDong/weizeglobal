      ...
      <View style={styles.mainContainer}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} bounces={false} style={styles.container}>
          ...
          <View style={styles.buttonsContainer}>
            <ButtonBox onPress={this.openComponents} style={styles.componentButton} image={Images.components} text='Video Conference' />
            <ButtonBox onPress={this.openUsage} style={styles.usageButton} image={Images.usageExamples} text='Find Student' />
          </View>
          <View style={styles.buttonsContainer}>
            <ButtonBox onPress={this.openApi} style={styles.apiButton} image={Images.api} text='Find Tutor' />
            <ButtonBox onPress={this.openTheme} image={Images.theme} text='My Profile' />
          </View>
          <View style={styles.buttonsContainer}>
